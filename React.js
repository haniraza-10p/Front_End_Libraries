...
class Fruits extends React.Component {
  ...
  render() {
    return (
      <div>
        <h2>Fruits:</h2>
        <NonCitrus /> {/* Already Defined */}
        <Citrus /> {/* Already Defined */}
      </div>
    );
  }
};

//Calling using Render
...
//Check Data type and isRequired
const Items = (props) => {
  return <h1>Current Quantity of Items in Cart: {props.quantity}</h1>
};
...
class MyComponent extends React.Component {
  ...
  componentWillMount() {
    console.log('Trying ComponentWillMount');
  }
  render() {
    return <div />
  }
...
//Checking type and type of props
